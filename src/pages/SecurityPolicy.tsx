...
export function SecurityPolicy() {
  return (
    <div className="max-w-4xl mx-auto space-y-12 pb-20 px-4 sm:px-6">
      <div className="flex items-center gap-2 text-sm font-medium text-slate-500 dark:text-slate-400 pt-8">
      ...
      <div className="space-y-8">
        <Card className="p-8 space-y-6">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Local First by Default</h2>
          </div>
        ...
        <Card className="p-8 space-y-6">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Cloud Sync Security</h2>
          </div>
          <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
        ...
        <Card className="p-8 space-y-6">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Payment Security</h2>
          </div>
          <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
