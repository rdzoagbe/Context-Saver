 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yd=1e3,Jd=2,Xd=4*60*60*1e3,Zd=.5;function qE(n,e=Yd,t=Jd){const r=e*Math.pow(t,n),s=Math.round(Zd*r*(Math.random()-.5)*2);return Math.min(Xd,r+s)}/**
 * @license
